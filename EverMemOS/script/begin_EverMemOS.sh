...
# source /home/shm/document/EverMemOS-main/.venv/bin/activate

cd /home/shm/document/EverMemOS-main
...
ENV_FILE="/home/shm/document/EverMemOS-main/.env"
...
update_env_var "LLM_BASE_URL" "$OPENAI_API_BASE"
update_env_var "LLM_API_KEY" "$OPENROUTER_API_KEY"
