...
class OpenAIClient:
    def __init__(self, api_key, base_url, model="gpt-4o-mini", log_path="/home/shm/document/MEMORY_ACCLERATION/results/glm-4-9b-chat-1m-GGUF_MemoryOS_longmemeval_oracle_mem/prompt_cal_log_o.json"):
        self.api_key = api_key
        self.base_url = base_url
        self.model = model
    ...
    def _log_request_content(self, messages):
        with self.lock:
            log_path="/home/shm/document/MEMORY_ACCLERATION/results/glm-4-9b-chat-1m-GGUF_MemoryOS_longmemeval_oracle_mem/log_o_all_query.json"
