...
def process_longmemeval(dataset_path: str, save_path: str):
    ## longmemeval
...
def process_locomo10(dataset_path: str, save_path: str):
    ## locomo10
    from tqdm import tqdm
    import json
    in_data = json.load(open(dataset_path))
...
def dataprocess(dataset: str, dataset_path: str, save_path: str):
    if dataset == 'locomo10':
        process_locomo10(dataset_path, save_path)
    elif dataset.startswith('longmemeval'):
        process_longmemeval(dataset_path, save_path)
    else:
